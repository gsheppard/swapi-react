...
exports.UPDATE_SRC = exports.RECEIVE_ITEMS = exports.REQUEST_ITEMS = undefined;
...
var UPDATE_SRC = exports.UPDATE_SRC = 'UPDATE_SRC';
...
function fetchAllItems(searchStr) {
  var endpoints = ['https://swapi.co/api/people/?search=' + searchStr, 'https://swapi.co/api/films/?search=' + searchStr, 'https://swapi.co/api/starships/?search=' + searchStr, 'https://swapi.co/api/species/?search=' + searchStr, 'https://swapi.co/api/planets/?search=' + searchStr];
  ...
  return function (dispatch) {
    ...
    return Promise.all(endpoints.map(function (url) {
      ...
      return prepareItems(array);
    }).then(function (json) {
      return dispatch(receiveItems(searchStr, json));
    });
  };
}

function shouldFetchItems(state, searchStr) {
  var posts = state.itemsBySearchString[searchStr];
  if (!posts) {
    return true;
...
function fetchItemsIfNeeded(searchStr) {
...
*/
var aa=__webpack_require__(5),ba=__webpack_require__(1),m=__webpack_require__(13),p=__webpack_require__(3),v=__webpack_require__(4),da=__webpack_require__(14),ea=__webpack_require__(15),fa=__webpack_require__(16),ha=__webpack_require__(6);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(11), __webpack_require__(47)(module)))
...
var _items = __webpack_require__(65);
...
var enhancer = composeEnhancers((0, _redux.applyMiddleware)(_reduxThunk2.default, logger));

function configureStore(preloadedState) {
  return (0, _redux.createStore)(_items2.default, preloadedState, enhancer);
}
...
function items() {
  ...
  switch (action.type) {
    case _items.REQUEST_ITEMS:
      return Object.assign({}, state, {
        searchStr: action.searchStr,
        isFetching: true
      });
    case _items.RECEIVE_ITEMS:
      return Object.assign({}, state, {
        isFetching: false,
        items: action.items
      });
...
function itemsBySearchString() {
  ...
  switch (action.type) {
    case _items.RECEIVE_ITEMS:
    case _items.REQUEST_ITEMS:
      return Object.assign({}, state, _defineProperty({}, action.searchStr, items(state[action.searchStr], action)));
    default:
      return state;
  }
}
...
exports.default = (0, _redux.combineReducers)({
  itemsBySearchString: itemsBySearchString,
  searchStr: searchStr
});
...
var _Results = __webpack_require__(72);
  ...
  _createClass(AsyncApp, [{
    ...
    value: function componentDidMount() {
      var _props = this.props,
          ...
          searchStr = _props.searchStr;

      dispatch((0, _items.fetchItemsIfNeeded)(searchStr));
    }
  }, {
    key: 'handleChange',
    value: function handleChange(searchStr) {
      this.props.dispatch((0, _items.fetchItemsIfNeeded)(searchStr));
    }
  }, {
    key: 'render',
    value: function render() {
      var _props2 = this.props,
          searchStr = _props2.searchStr,
          items = _props2.items,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_Search2.default, { value: searchStr, onChange: this.handleChange })
        ),
        _react2.default.createElement(
          'section',
          { className: 'content' },
          isFetching && items.length === 0 && _react2.default.createElement(_Loader2.default, null),
          !isFetching && items.length === 0 && _react2.default.createElement(
            'h2',
            null,
            'No Results'
          ),
          items.length > 0 && _react2.default.createElement(_Results2.default, { items: items }),
          _react2.default.createElement(
            'div',
            { className: 'tagline' },
            ...
            _react2.default.createElement(
              'a',
              { href: 'http://www.robbg.io' },
              'Rob BG'
            ),
            ' using React / Redux.\xA0',
            _react2.default.createElement(
              'a',
              { href: 'https://github.com/robertbg/react-example' },
              'Source code on Github'
            ),
            '.',
            _react2.default.createElement(
              'svg',
              { className: 'tagline__logo', viewBox: '0 0 115 50' },
              _react2.default.createElement('path', {
                className: 'logo__dot',
                strokeWidth: '2',
                strokeMiterlimit: '10',
                d: 'M105.9,44.8c0-0.8,0.3-1.5,0.9-2.1c0.6-0.6,1.3-0.9,2.1-0.9c0.8,0,1.5,0.3,2.1, 0.9c0.6,0.6,0.9,1.3,0.9,2.1s-0.3,1.6-0.9,2.1c-0.6,0.6-1.3,0.9-2.1,0.9c-0.8, 0-1.5-0.3-2.1-0.9C106.2,46.3,105.9,45.6,105.9,44.8z'
              }),
              _react2.default.createElement('path', {
                strokeWidth: '2',
                strokeMiterlimit: '10',
                d: 'M106,25.4c0.1,0.9,0.1,1.8,0.1,2.7c0,5.5-1.9,10.1-5.8,13.9c-3.8,3.8-8.5, 5.7-13.9,5.7c-5.5,0-10.1-1.9-14-5.8c-3.8-3.8-5.8-8.5-5.8-14c0-5.4,1.9-10.1, 5.8-13.9c3.8-3.8,8.5-5.8,14-5.8c3.9,0,7.6,1.1,10.9,3.2c3.2,2.1,5.5,4.9,7.1, 8.4h-6c-2.9-4.2-6.9-6.3-12-6.3c-4,0-7.4,1.4-10.2,4.2c-2.8,2.8-4.2,6.2-4.2,10.1c0, 4,1.4,7.4,4.2,10.2c2.8,2.8,6.2,4.2,10.2,4.2c3.5,0,6.5-1.1,9.2-3.3c2.7-2.2,4.3-5, 4.9-8.4h-14v-5.3H106z'
              }),
              _react2.default.createElement('path', {
                strokeWidth: '2',
                strokeMiterlimit: '10',
                d: 'M25.6,3.1h5.3v11.4c3.9-4.1,8.7-6.2,14.3-6.2c5.5,0,10.1,1.9,14,5.8C63,18,64.9, 22.6,64.9,28c0,5.5-1.9,10.1-5.8,14c-3.8,3.8-8.5,5.8-14,5.8c-5.4, 0-10.1-1.9-13.9-5.8c-3.8-3.8-5.8-8.5-5.8-14V3.1z M35.1,17.9c-2.8,2.8-4.2,6.2-4.2, 10.1c0,4,1.4,7.4,4.2,10.2c2.8,2.8,6.2,4.2,10.1,4.2c4,0,7.4-1.4,10.2-4.2S59.6,32, 59.6,28c0-3.9-1.4-7.3-4.2-10.1c-2.8-2.8-6.2-4.2-10.2-4.2C41.3,13.7,37.9,15.1,35.1, 17.9z'
              }),
              _react2.default.createElement('path', {
                strokeWidth: '2',
                strokeMiterlimit: '10',
                d: 'M4.2,28.4c0-5.4,1.9-10.1,5.8-13.9c3.8-3.9,8.5-5.8,13.9-5.8v5.4c-3.9,0-7.3, 1.4-10.1,4.2c-2.8,2.8-4.2,6.2-4.2,10.2v19.3H4.2V28.4z'
              })
            )
          )
        )
...
AsyncApp.propTypes = {
  searchStr: _propTypes2.default.string,
...
function mapStateToProps(state) {
  var searchStr = state.searchStr,
      itemsBySearchString = state.itemsBySearchString;

  var _ref = itemsBySearchString[searchStr] || {
    searchStr: searchStr,
    isFetching: true,
    items: []
  },
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement('div', {
        ...
        dangerouslySetInnerHTML: { __html: _search2.default }
      }),
...
module.exports = "<svg viewBox=\"0 0 56.966 56.966\"><path d=\"M55.146,51.887L41.588,37.786c3.486-4.144,5.396-9.358, 5.396-14.786c0-12.682-10.318-23-23-23s-23,10.318-23,23s10.318,23,23,23c4.761,0, 9.298-1.436,13.177-4.162l13.661,14.208c0.571,0.593,1.339,0.92,2.162,0.92c0.779,0, 1.518-0.297,2.079-0.837C56.255,54.982,56.293,53.08,55.146,51.887z M23.984,6c9.374,0,17, 7.626,17,17s-7.626,17-17,17s-17-7.626-17-17S14.61,6,23.984,6z\"></path></svg>"
...
var _person = __webpack_require__(73);

var _person2 = _interopRequireDefault(_person);

var _film = __webpack_require__(75);

var _film2 = _interopRequireDefault(_film);

var _planet = __webpack_require__(77);

var _planet2 = _interopRequireDefault(_planet);

var _starship = __webpack_require__(79);

var _starship2 = _interopRequireDefault(_starship);

var _species = __webpack_require__(81);
...
var Results = function Results(props) {
  return _react2.default.createElement(
    ...
    props.items.map(function (item, i) {
      switch (item.type) {
        case 'film':
          return _react2.default.createElement(_film2.default, { key: i, item: item });
        case 'planet':
          return _react2.default.createElement(_planet2.default, { key: i, item: item });
        case 'species':
          return _react2.default.createElement(_species2.default, { key: i, item: item });
        case 'starship':
          return _react2.default.createElement(_starship2.default, { key: i, item: item });
        default:
          return _react2.default.createElement(_person2.default, { key: i, item: item });
      }
    })
  );
};
...
var _vader = __webpack_require__(74);

var _vader2 = _interopRequireDefault(_vader);
...
var Person = function Person(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement('div', {
      ...
      id: props.item.type,
      dangerouslySetInnerHTML: { __html: _vader2.default }
    }),
    _react2.default.createElement(
      'ul',
...
Person.propTypes = {
  item: _propTypes2.default.shape({
    ...
    mass: _propTypes2.default.string,
...
var _film = __webpack_require__(76);
...
var Film = function Film(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement('div', {
      className: 'results__bg',
      id: props.item.type,
      dangerouslySetInnerHTML: { __html: _film2.default }
    }),
    _react2.default.createElement(
      'ul',
      { className: 'results__info' },
...
Film.propTypes = {
  item: _propTypes2.default.shape({
    ...
    episode_id: _propTypes2.default.number.isRequired,
    name: _propTypes2.default.string.isRequired,
    producer: _propTypes2.default.string,
...
var _planet = __webpack_require__(78);
...
var Planet = function Planet(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement('div', {
      className: 'results__bg',
      id: props.item.type,
      dangerouslySetInnerHTML: { __html: _planet2.default }
    }),
    _react2.default.createElement(
      'ul',
      { className: 'results__info' },
...
Planet.propTypes = {
  item: _propTypes2.default.shape({
    ...
    name: _propTypes2.default.string.isRequired,
    population: _propTypes2.default.string,
    type: _propTypes2.default.string
  })
};
...
module.exports = "<svg viewBox=\"211 19 50 42\"><polygon points=\"226.25 32.623 227.75 32.623 227.75 26.623 226.25 26.623\"></polygon><path d=\"M247.25,48.3732 C246.423,48.3732 245.75,47.7002 245.75,46.8732 C245.75,46.0462 246.423, 45.3732 247.25,45.3732 C248.077,45.3732 248.75,46.0462 248.75,46.8732 C248.75, 47.7002 248.077,48.3732 247.25,48.3732 L247.25,48.3732 Z M251,44.4042 L251, 41.6762 L248.25,39.8422 L246.123,44.0962 C245.026,44.5422 244.25,45.6152 244.25, 46.8732 C244.25,47.5532 244.485,48.1732 244.866,48.6762 L244.352,55.8732 L248.863, 55.8732 L249.353,49.0102 C249.906,48.4652 250.25,47.7102 250.25,46.8732 C250.25, 46.6112 250.206,46.3612 250.143,46.1192 L251,44.4042 Z\"></path><polygon points=\"250.6725 33.3732 259.2495 33.3732 259.2495 24.3732 251.7495 21.8982 250.2495 19.8732 239.7495 19.8732 238.2495 21.8982 232.2495 24.3732 232.2495 33.3732 239.3275 33.3732\"></polygon><path d=\"M218.75,32.6232 C217.507,32.6232 216.5,31.6162 216.5,30.3732 C216.5,29.1302 217.507, 28.1232 218.75,28.1232 C219.993,28.1232 221,29.1302 221,30.3732 C221,31.6162 219.993, 32.6232 218.75,32.6232 L218.75,32.6232 Z M223.25,33.3732 L224.75,33.3732 L224.75, 25.8732 L218.75,25.8732 L214.25,28.8732 L214.25,31.1232 L211.625,31.1232 C211.418, 31.1232 211.25,31.2912 211.25,31.4982 C211.25,31.7052 211.418,31.8732 211.625, 31.8732 L214.25,31.8732 L214.25,33.3732 L212,33.3732 C211.586,33.3732 211.25, 33.7092 211.25,34.1232 C211.25,34.5372 211.586,34.8732 212,34.8732 L221.75, 34.8732 L223.25,33.3732 Z\"></path><path d=\"M253.25,46.8732 C253.25,46.0462 253.923,45.3732 254.75,45.3732 C255.577,45.3732 256.25, 46.0462 256.25,46.8732 C256.25,47.7002 255.577,48.3732 254.75,48.3732 C253.923, 48.3732 253.25,47.7002 253.25,46.8732 L253.25,46.8732 Z M254.75,36.3732 C255.577, 36.3732 256.25,37.0462 256.25,37.8732 C256.25,38.7002 255.577,39.3732 254.75, 39.3732 C253.923,39.3732 253.25,38.7002 253.25,37.8732 C253.25,37.0462 253.923, 36.3732 254.75,36.3732 L254.75,36.3732 Z M235.25,39.3732 C234.423,39.3732 233.75, 38.7002 233.75,37.8732 C233.75,37.0462 234.423,36.3732 235.25,36.3732 C236.077, 36.3732 236.75,37.0462 236.75,37.8732 C236.75,38.7002 236.077,39.3732 235.25, 39.3732 L235.25,39.3732 Z M232.25,48.3732 C231.423,48.3732 230.75,47.7002 230.75, 46.8732 C230.75,46.0462 231.423,45.3732 232.25,45.3732 C233.077,45.3732 233.75, 46.0462 233.75,46.8732 C233.75,47.7002 233.077,48.3732 232.25,48.3732 L232.25, 48.3732 Z M258.98,55.8732 L257.362,48.3222 C257.602,47.8912 257.75,47.4012 257.75, 46.8732 C257.75,46.1172 257.461,45.4352 257,44.9082 L257,41.2482 L258.821,34.8732 L235.25, 34.8732 C233.593,34.8732 232.25,36.2162 232.25,37.8732 C232.25,38.2892 232.335, 38.6852 232.488,39.0452 L230.738,44.2962 C229.852,44.8172 229.25,45.7702 229.25, 46.8732 C229.25,47.2642 229.33,47.6352 229.466,47.9782 L226.646,55.8732 L231.425, 55.8732 L232.469,52.9482 L236.327,54.8082 L238.278,50.7522 L234.404,48.9282 C234.921, 48.3922 235.25,47.6772 235.25,46.8732 C235.25,46.4572 235.165,46.0612 235.012, 45.7012 L236.438,41.4222 L240.875,37.8732 L248,37.8732 L252.5,40.8732 L252.5, 44.6702 L252.5,44.9082 C252.039,45.4352 251.75,46.1172 251.75,46.8732 C251.75, 47.8802 252.25,48.7652 253.011,49.3102 L254.387,55.8732 L258.98,55.8732 Z\"></path><polygon points=\"229.25 32.623 230.75 32.623 230.75 26.623 229.25 26.623\"></polygon><polygon points=\"240.8468 50.6015 239.7648 51.1215 237.3258 56.1905 237.5958 57.3605 239.6228 58.3355 242.8748 51.5765\"></polygon><polygon points=\"259.8125 57.3732 254.1875 57.3732 253.2505 58.1232 253.2505 60.3732 260.7495 60.3732 260.7495 58.1232\"></polygon><polygon points=\"243.6875 57.3732 242.7505 58.1232 242.7505 60.3732 250.2495 60.3732 250.2495 58.1232 249.3125 57.3732\"></polygon><polygon points=\"225.6875 57.3732 224.7505 58.1232 224.7505 60.3732 232.2495 60.3732 232.2495 58.1232 231.3125 57.3732\"></polygon><path d=\"M223.25,46.8732 C223.25,46.0462 223.923,45.3732 224.75,45.3732 C225.577,45.3732 226.25, 46.0462 226.25,46.8732 C226.25,47.7002 225.577,48.3732 224.75,48.3732 C223.923, 48.3732 223.25,47.7002 223.25,46.8732 M225.569,49.7452 L227.001,50.4192 L227.884, 47.9492 C227.795,47.5952 227.75,47.2352 227.75,46.8732 C227.75,45.4982 228.398, 44.1952 229.473,43.3482 L231.099,38.4682 L224.789,43.8772 C224.775,43.8772 224.763, 43.8732 224.75,43.8732 C223.093,43.8732 221.75,45.2162 221.75,46.8732 C221.75, 48.5302 223.093,49.8732 224.75,49.8732 C225.036,49.8732 225.307,49.8202 225.569,49.7452\"></path></svg>"
...
var _starship = __webpack_require__(80);
...
var Film = function Film(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement('div', {
      className: 'results__bg',
      id: props.item.type,
      dangerouslySetInnerHTML: { __html: _starship2.default }
    }),
    _react2.default.createElement(
      'ul',
      { className: 'results__info' },
...
Film.propTypes = {
  item: _propTypes2.default.shape({
    ...
    name: _propTypes2.default.string.isRequired,
    manufacturer: _propTypes2.default.string,
    hyperdrive_rating: _propTypes2.default.string,
    type: _propTypes2.default.string.isRequired
  })
};
...
module.exports = "<svg viewBox=\"99 205 42 43\"><path d=\"M112.5,209.75 C115.814,209.75 118.5,212.436 118.5,215.75 C118.5,219.063 115.814, 221.75 112.5,221.75 C109.186,221.75 106.5,219.063 106.5,215.75 C106.5,212.436 109.186, 209.75 112.5,209.75 L112.5,209.75 Z M140.962,225.5 C140.916,224.218 140.77, 222.963 140.505,221.75 L132,221.75 L132,220.25 L135,220.25 L135,218.75 L129,218.75 L129, 217.25 L133.5,217.25 L133.5,215.75 L132,215.75 L132,214.25 L129,214.25 L129,212.75 L130.5, 212.75 L130.5,211.25 L127.5,211.25 L127.5,209.75 L129,209.75 L129,208.25 L129, 207.298 C126.27,205.998 123.226,205.25 120,205.25 C108.655,205.25 99.436,214.251 99.038, 225.5 L140.962,225.5 Z\"></path><path d=\"M124.5,245.75 L123,245.75 L123,244.25 L127.5,244.25 L127.5,242.75 L129,242.75 L129, 241.25 L133.5,241.25 L133.5,239.75 L135,239.75 L135,238.25 L132,238.25 L132,236.75 L127.5, 236.75 L127.5,235.25 L130.5,235.25 L130.5,233.75 L136.5,233.75 L136.5,232.25 L133.5, 232.25 L133.5,230.75 L140.505,230.75 C140.77,229.537 140.916,228.282 140.962,227 L99.038, 227 C99.436,238.249 108.655,247.25 120,247.25 C121.547,247.25 123.05,247.071 124.5, 246.755 L124.5,245.75 Z\"></path></svg>"
...
var _wookie = __webpack_require__(82);
...
var Film = function Film(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement('div', {
      className: 'results__bg',
      id: props.item.type,
      dangerouslySetInnerHTML: { __html: _wookie2.default }
    }),
    _react2.default.createElement(
      'ul',
      { className: 'results__info' },
...
Film.propTypes = {
  item: _propTypes2.default.shape({
    designation: _propTypes2.default.string,
    name: _propTypes2.default.string.isRequired,
    classification: _propTypes2.default.string,
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'dot dot-1' },
          _react2.default.createElement('div', { className: 'line line-1' }),
          _react2.default.createElement('div', { className: 'line line-2' }),
          _react2.default.createElement('div', { className: 'line line-3' })
        ),
        _react2.default.createElement('div', { className: 'dot dot-2' }),
        _react2.default.createElement('div', { className: 'circle circle-1' }),
        _react2.default.createElement('div', { className: 'circle circle-2' }),
        _react2.default.createElement('div', { className: 'circle circle-3' })
      ),
      _react2.default.createElement(
        'div',
        { className: 'body-shadow-crop' },
        _react2.default.createElement('div', { className: 'body-shadow' })
      ),
      _react2.default.createElement(
        'div',
        { className: 'bb8-head' },
        _react2.default.createElement(
          ...
          _react2.default.createElement('div', { className: 'head-side-1' }),
          _react2.default.createElement('div', { className: 'head-side-2' }),
          _react2.default.createElement('div', { className: 'head-bottom-base' })
        ),
        _react2.default.createElement(
          'div',
          { className: 'head-top-crop' },
          _react2.default.createElement('div', { className: 'head-top' })
        ),
        _react2.default.createElement('div', { className: 'lens' }),
        _react2.default.createElement('div', { className: 'freckle' })
      )
    )
  );
};
